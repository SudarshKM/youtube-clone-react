    ...
    <Dropdown>
      ...
      <Dropdown.Menu className="bg-dark dropDownItem">
        <Dropdown.Item className="text-light" href="#/action-1">
          <Link to={"/User"} style={{textDecoration:"none" , color:"white"}}>Sudarsh K M : Sync On</Link>
        </Dropdown.Item>
        <hr className="text-light" />

        <Dropdown.Item className="text-light" href="#/action-1">
          <FontAwesomeIcon className="me-3" icon={faGoogle} />
          Google Account
        </Dropdown.Item>
        ...
        <Dropdown.Item className="text-light" href="#/action-4">
          <FontAwesomeIcon className="me-3" icon={faSquareYoutube} />
          Youtube Studio
        </Dropdown.Item>
        <Dropdown.Item className="text-light" href="#/">
          <FontAwesomeIcon className="me-3" icon={faDollarSign} />
        ...
        <Dropdown.Item className="text-light" href="#/">
          <FontAwesomeIcon className="me-3" icon={faKeyboard} />
          Keyboard shortcuts
        </Dropdown.Item>
        <Dropdown.Item className="text-light" href="#/">
          <FontAwesomeIcon className="me-3" icon={faEyeSlash} />
          Restricted Mode : Off
        </Dropdown.Item>
        <Dropdown.Item className="text-light" href="#/">
          <FontAwesomeIcon className="me-3" icon={faGlobe} />
          Location : India
        </Dropdown.Item>
        <hr className="text-light" />
        <Dropdown.Item className="text-light" href="#/">
